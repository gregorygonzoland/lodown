 ...
 * 
 * @param {value}: The value which the function will find and return.
 */
 ...
 * @param {number}: the number chosen to be spliced out.
 */
 ...
 *                  pick out.
 * @param {number}: the number(element) chosen to be spliced out.
 */
  ...
  */
   ...
   *         is true.
   * 
   * @param {collection}: the array in which the numbers that are returned to true
   *                      are filtered out to.
   * 
 ...
 *         false to an array
 * 
 * @param {collection}: the array in which the numbers that return false are 
 *                      rejected to.
 * 
 ...
 */
  ...
  */
   ...
   */
    ...
    * 
    * @param {collection}: The array or the collection.
    * 
  ...
  */
   ...
   * 
   * @param {collection}: the collection to be looped through.
   * 
